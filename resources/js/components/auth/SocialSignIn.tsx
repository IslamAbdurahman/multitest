...
const SocialSignIn = () => {
    ...
    useEffect(() => {
        ...
        script.async = true;
        script.setAttribute('data-telegram-login', 'MultitestUzBot');
        script.setAttribute('data-size', 'large');
        script.setAttribute('data-userpic', 'false');
        script.setAttribute('data-request-access', 'write');
        script.setAttribute('data-auth-url', 'https://multitest.uz/auth/telegram/callback');
        script.setAttribute('data-radius', '10');
        // Sync widget language with app language
        script.setAttribute('data-lang', i18n.language === 'uz' ? 'en' : i18n.language);
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex flex-col items-center justify-center">
                <div id="telegram-container" className="min-h-[40px]"></div>
            </div>
        </div>
    );
};
...
const GitHubIcon = () => (
    <svg width="20" height="20" viewBox="0 0 22 22" fill="none" className="text-slate-900 dark:text-white">
        <path
